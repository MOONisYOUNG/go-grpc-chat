...
func (c *chatServiceClient) Chat(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ChatMsg, ChatMsg], error) {
...
type ChatService_ChatClient = grpc.BidiStreamingClient[ChatMsg, ChatMsg]
...
func (UnimplementedChatServiceServer) Chat(grpc.BidiStreamingServer[ChatMsg, ChatMsg]) error {
...
func _ChatService_Chat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChatServiceServer).Chat(&grpc.GenericServerStream[ChatMsg, ChatMsg]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChatService_ChatServer = grpc.BidiStreamingServer[ChatMsg, ChatMsg]
